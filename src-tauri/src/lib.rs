...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::tasks::complete_task_group,
            ...
            commands::tasks::bulk_update_tasks_done,
            commands::tasks::bulk_delete_tasks_with_snapshot,
            commands::tasks::restore_tasks,
            commands::tasks::bulk_move_tasks,
            ...
            commands::tasks::get_calendar_tasks,
            commands::tasks::create_calendar_task,
            commands::tasks::update_calendar_task,
            commands::tasks::remove_task_from_schedule,
            commands::tasks::cancel_task_recurrence,
            commands::tasks::delete_recurring_tasks,
            commands::tasks::ensure_recurring_task_instances,
